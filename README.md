...
当前生存链已从燧石阶段贯通到 Underworld 与艾德曼阶段：九级工具台、六类炉体、热量 1–4、七种金属的基础/特殊工具、武器、板甲与锁链甲、银/秘银/艾德曼矿物，以及 Underworld 地牢中的远古金属来源均已接通。Underworld 使用独立维度类型、石头/深板岩下部地层、`Y=140` 水位、`Y=128` 以上的分层大型洞穴、贯通洞口、基岩顶棚、生物群系、怪物房和专属艾德曼矿；其中 `Y=128–215` 第一层复用 MITE 1.6.4 R196 `ChunkProviderUnderworld` 的旧式混合密度核心和纵向余弦剖面，`Y=216–225` 石质分隔层则以起伏洞顶/洞底和倾斜峡谷裂隙、3D 洞穴管道自然衔接上下洞穴。主世界底部接触基岩的黑曜石门负责双向进入与安全返回。
