...
## MITE R196 workbench, material and equipment textures

InfiniteX includes selected workbench, material and equipment textures copied byte-for-byte from the locally supplied MITE R196 resource pack described by its metadata as “A Minecraft New Pack For 1.6.4-MITE Version:1.0.3 By Modded MITE Community.” Resource paths and filenames were adapted to the `infx` namespace for modern Minecraft.
