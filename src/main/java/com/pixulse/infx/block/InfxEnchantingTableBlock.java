...
public final class InfxEnchantingTableBlock extends EnchantingTableBlock {
    private final InfxEnchantmentMenu.Kind kind;

    public InfxEnchantingTableBlock(InfxEnchantmentMenu.Kind kind, BlockBehaviour.Properties properties) {
        super(properties);
        this.kind = kind;
    }

    public InfxEnchantmentMenu.Kind kind() {
        return kind;
    }
    ...
    protected @Nullable MenuProvider getMenuProvider(@NonNull BlockState state, Level level, @NonNull BlockPos pos) {
        ...
        return new SimpleMenuProvider(
                (containerId, inventory, player) -> new InfxEnchantmentMenu(
