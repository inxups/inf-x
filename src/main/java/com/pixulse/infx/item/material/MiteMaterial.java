...
public enum MiteMaterial {
    LEATHER("leather", "Leather", "Leather", "皮革", 1, 10, Quality.FINE, 0, 0, null,
            BlockTags.INCORRECT_FOR_WOODEN_TOOL, "leather", 2, 0),
    WOOD("wood", "Wood", "Wooden", "木", .5F, 10, Quality.FINE, 0, 1, null,
            BlockTags.INCORRECT_FOR_WOODEN_TOOL, "wood", 0, 0),
    FLINT("flint", "Flint", "Flint", "燧石", 1, 0, Quality.FINE, 1, 1.25F, HarvestTier.FLINT,
            BlockTags.INCORRECT_FOR_WOODEN_TOOL, "flint", 0, 0, Flag.ROCKY),
    OBSIDIAN("obsidian", "Obsidian", "Obsidian", "黑曜石", 2, 0, Quality.FINE, 2, 1.5F, HarvestTier.COPPER,
            BlockTags.INCORRECT_FOR_COPPER_TOOL, "obsidian", 0, 0, Flag.ROCKY),
    GOLD("gold", "Gold", "Golden", "金", 4, 50, Quality.SUPERB, 2, 1.75F, HarvestTier.COPPER,
            BlockTags.INCORRECT_FOR_COPPER_TOOL, "gold", 6, 3, Flag.METAL),
    COPPER("copper", "Copper", "Copper", "铜", 4, 30, Quality.EXCELLENT, 3, 1.75F, HarvestTier.COPPER,
            BlockTags.INCORRECT_FOR_COPPER_TOOL, "copper", 7, 4, Flag.METAL),
    SILVER("silver", "Silver", "Silver", "银", 4, 30, Quality.EXCELLENT, 3, 1.75F, HarvestTier.COPPER,
            BlockTags.INCORRECT_FOR_COPPER_TOOL, "silver", 7, 4, Flag.METAL, Flag.SILVER),
    RUSTED_IRON("rusted_iron", "Rusted Iron", "Rusted Iron", "锈铁", 4, 0, Quality.POOR, 2, 1.25F,
            HarvestTier.COPPER, BlockTags.INCORRECT_FOR_COPPER_TOOL, "iron", 6, 0, Flag.METAL, Flag.RUSTED),
    IRON("iron", "Iron", "Iron", "铁", 8, 30, Quality.MASTERWORK, 4, 2, HarvestTier.IRON,
            BlockTags.INCORRECT_FOR_IRON_TOOL, "iron", 8, 5, Flag.METAL),
    ANCIENT_METAL("ancient_metal", "Ancient Metal", "Ancient Metal", "远古金属", 16, 40, Quality.MASTERWORK, 4,
            2, HarvestTier.ANCIENT_METAL, BlockTags.INCORRECT_FOR_NETHERITE_TOOL, "ancient_metal", 8, 5, Flag.METAL),
    MITHRIL("mithril", "Mithril", "Mithril", "秘银", 64, 100, Quality.LEGENDARY, 5, 2.5F, HarvestTier.MITHRIL,
            BlockTags.INCORRECT_FOR_NETHERITE_TOOL, "mithril", 9, 6, Flag.METAL),
    ADAMANTIUM("adamantium", "Adamantium", "Adamantium", "艾德曼", 256, 40, Quality.LEGENDARY, 6, 3,
    ...
    private final Quality maximumQuality;
    ...
    public Quality maximumQuality() { return maximumQuality; }
