...
public final class MiteChicken extends Chicken {
    /**
    ...
    private static final EntityDataAccessor<Boolean> DATA_WELL =
            SynchedEntityData.defineId(MiteChicken.class, EntityDataSerializers.BOOLEAN);
    private static final String NEXT_FEATHER = "infx_chicken_next_feather";
    private static final long FEATHER_INTERVAL = 96_000L;

    public MiteChicken(EntityType<? extends Chicken> type, Level level) {
        super(type, level);
    }
    ...
    public @Nullable Chicken getBreedOffspring(ServerLevel level, AgeableMob partner) {
        return InfinityXEntityTypes.R196_CHICKEN.get().create(level, EntitySpawnReason.BREEDING);
    }
}
