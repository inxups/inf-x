...
public final class MiteSquid extends Squid implements MiteMob {
    ...
    public MiteSquid(EntityType<? extends Squid> type, Level level) {
        super(type, level);
    }
    ...
    private static boolean canPreyUpon(ServerLevel level, LivingEntity candidate) {
        ...
        return candidate instanceof Animal
                && !(candidate instanceof MiteWolf wolf && wolf.variant() == MiteWolf.Variant.HELLHOUND)
