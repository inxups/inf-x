...
public final class MitePig extends Pig {
    /**
    ...
    private static final EntityDataAccessor<Boolean> DATA_WELL =
            SynchedEntityData.defineId(MitePig.class, EntityDataSerializers.BOOLEAN);

    public MitePig(EntityType<? extends Pig> type, Level level) {
        super(type, level);
    }
