...
public final class MiteSilverfish extends Silverfish implements MiteMob {
    ...
    public MiteSilverfish(EntityType<? extends Silverfish> type, Level level) {
        super(type, level);
    ...
    private static final class MiteWakeUpFriendsGoal extends Goal {
        private final MiteSilverfish silverfish;
        private int ticksUntilWake;

        private MiteWakeUpFriendsGoal(MiteSilverfish silverfish) {
