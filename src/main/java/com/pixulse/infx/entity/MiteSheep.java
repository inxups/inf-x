...
public final class MiteSheep extends Sheep {
    /**
    ...
    private static final EntityDataAccessor<Boolean> DATA_WELL =
            SynchedEntityData.defineId(MiteSheep.class, EntityDataSerializers.BOOLEAN);

    public MiteSheep(EntityType<? extends Sheep> type, Level level) {
        super(type, level);
    }
