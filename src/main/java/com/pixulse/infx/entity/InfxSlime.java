...
/** Vanilla slime replacement and the four corrosive INFX gelatinous cubes. */
public final class InfxSlime extends Slime implements InfxMob {
    ...
    public InfxSlime(EntityType<? extends Slime> type, Level level) {
        super(type, level);
    ...
    private static final class OozePursuitGoal extends Goal {
        private final InfxSlime slime;

        private OozePursuitGoal(InfxSlime slime) {
            this.slime = slime;
    ...
    private static final class OozeRandomMovementGoal extends Goal {
        ...
        private OozeRandomMovementGoal(InfxSlime slime) {
            this.slime = slime;
