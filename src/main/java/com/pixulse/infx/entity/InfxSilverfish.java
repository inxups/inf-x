...
/** Explosive, venomous and paralyzing INFX silverfish variants. */
public final class InfxSilverfish extends Silverfish implements InfxMob {
    public enum Variant {
        NETHERSPAWN,
        COPPERSPINE,
        HOARY
    ...
    private static final class InfxWakeUpFriendsGoal extends Goal {
        private final InfxSilverfish silverfish;
        private int ticksUntilWake;

        private InfxWakeUpFriendsGoal(InfxSilverfish silverfish) {
