...
/** Skeleton bow goal whose R196 radius is a hard draw-and-release boundary. */
final class MiteHardLimitedBowAttackGoal<T extends Mob & RangedAttackMob> extends Goal {
    private final T mob;
