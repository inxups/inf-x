 ...
 */
public final class MiteBlaze extends Blaze implements MiteMob {
    ...
    private static final EntityDataAccessor<Boolean> DATA_MITE_CHARGED =
            SynchedEntityData.defineId(MiteBlaze.class, EntityDataSerializers.BOOLEAN);

    public MiteBlaze(EntityType<? extends Blaze> type, Level level) {
        super(type, level);
    ...
    protected void registerGoals() {
        ...
        goalSelector.addGoal(4, new MiteFireballGoal(this));
    }
