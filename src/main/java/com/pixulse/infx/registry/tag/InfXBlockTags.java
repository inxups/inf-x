...
public final class InfXBlockTags {
    ...
    public static final TagKey<Block> GRAVITY_SOILS = create("gravity_soils");
    public static final TagKey<Block> SLIDING_FALLING_BLOCKS = create("sliding_falling_blocks");
