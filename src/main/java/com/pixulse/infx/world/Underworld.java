...
public final class Underworld {
    ...
    public static final int COPPER_ORE_LOW_COUNT = 48;
    public static final int COPPER_ORE_FULL_COUNT = 16;
    public static final int COPPER_ORE_SIZE = 6;
    public static final int SILVER_ORE_LOW_COUNT = 12;
    public static final int SILVER_ORE_FULL_COUNT = 4;
    public static final int SILVER_ORE_SIZE = 6;
    public static final int GOLD_ORE_LOW_COUNT = 24;
    public static final int GOLD_ORE_FULL_COUNT = 8;
    public static final int GOLD_ORE_SIZE = 4;
    public static final int IRON_ORE_LOW_COUNT = 72;
    public static final int IRON_ORE_FULL_COUNT = 24;
    public static final int IRON_ORE_SIZE = 6;
    public static final int MITHRIL_ORE_LOW_COUNT = 12;
    public static final int MITHRIL_ORE_FULL_COUNT = 4;
    public static final int MITHRIL_ORE_SIZE = 3;
    public static final int ADAMANTIUM_ORE_LOW_COUNT = 16;
    public static final int ADAMANTIUM_ORE_SIZE = 3;
    public static final int REDSTONE_ORE_LOW_COUNT = 12;
    public static final int REDSTONE_ORE_FULL_COUNT = 4;
    public static final int REDSTONE_ORE_SIZE = 5;
    public static final int DIAMOND_ORE_LOW_COUNT = 6;
    public static final int DIAMOND_ORE_FULL_COUNT = 2;
    public static final int DIAMOND_ORE_SIZE = 3;
    public static final int LAPIS_ORE_LOW_COUNT = 6;
    public static final int LAPIS_ORE_FULL_COUNT = 2;
