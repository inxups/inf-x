 ...
 */
public final class SwimPhysics {
    private SwimPhysics() {}
    ...
    public static void applyNormalizedCurrent(Entity entity, double scale) {
        Vec3 impulse = SwimRules.currentImpulse(accumulatedCurrentFlow(entity), scale);
    ...
    public static Vec3 applyFallingWaterSprintGravity(
        ...
        return new Vec3(
                movement.x,
                SwimRules.sprintWaterfallVerticalMovement(movement.y, waterBaseGravity),
                movement.z);
    }
    ...
    public static double swimUpImpulse(LivingEntity entity) {
        ...
        float factor = SwimRules.swimUpFactor(
                feetInLiquid,
                fallingColumn,
                drawingBow,
                suspended,
    ...
    public static float speedModifier(LivingEntity entity) {
        ...
        return SwimRules.speedModifier(
