...
public final class R196SafeSpecialRenderer implements NoDataSpecialModelRenderer {
    ...
    private R196SafeSpecialRenderer(SpriteGetter sprites, R196SafeModel model, SpriteId sprite) {
    ...
    public record Unbaked(Identifier texture) implements NoDataSpecialModelRenderer.Unbaked {
        ...
        @Override
        public R196SafeSpecialRenderer bake(SpecialModelRenderer.BakingContext context) {
            R196SafeModel model = new R196SafeModel(context.entityModelSet().bakeLayer(R196SafeModel.LAYER));
            SpriteId fullTexture = Sheets.CHEST_MAPPER.apply(texture);
            return new R196SafeSpecialRenderer(context.sprites(), model, fullTexture);
        }
    }
}
