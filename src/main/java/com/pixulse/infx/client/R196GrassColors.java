...
public final class R196GrassColors {
    private R196GrassColors() {}
    ...
    static BlockTintSource trampledGrassBlock() {
        return new BlockTintSource() {
            ...
            public int colorInWorld(BlockState state, BlockAndTintGetter level, BlockPos pos) {
                ...
                return R196GrassTrampling.blendColor(biome, tramplings);
            }
    ...
    private static int clientTramplings(BlockAndTintGetter level, BlockPos pos) {
        ...
        return R196GrassTrampling.getTramplings(world, pos);
    }
}
