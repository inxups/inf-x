...
public enum CurseType implements StringRepresentable {
    ...
    public static final Codec<CurseType> CODEC = StringRepresentable.fromEnum(CurseType::values);
    private static final CurseType[] BY_ID = new CurseType[17];
    ...
    public static @Nullable CurseType byId(int id) {
    ...
    public static CurseType forWitch(int witchSeed, String username) {
        int combinedSeed = witchSeed + originalUsernameHash(username);
        return random(new Random(combinedSeed));
    }
}
