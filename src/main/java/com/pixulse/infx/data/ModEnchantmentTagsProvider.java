...
final class ModEnchantmentTagsProvider extends KeyTagsProvider<Enchantment> {
    ...
    protected void addTags(HolderLookup.Provider registries) {
        for (TagKey<Enchantment> source : List.of(
            ...
            tag(source, true).add(InfinityXEnchantments.ALL.toArray(net.minecraft.resources.ResourceKey[]::new));
        }
    }
}
