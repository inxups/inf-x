...
class UnderworldTest {
    ...
    void verticalRangeSpansTheDeepslateBaseAndShiftedTerrain() {
        ...
        assertEquals(48, Underworld.COPPER_ORE_LOW_COUNT);
        assertEquals(16, Underworld.COPPER_ORE_FULL_COUNT);
        assertEquals(6, Underworld.COPPER_ORE_SIZE);
        assertEquals(12, Underworld.SILVER_ORE_LOW_COUNT);
        assertEquals(4, Underworld.SILVER_ORE_FULL_COUNT);
        assertEquals(6, Underworld.SILVER_ORE_SIZE);
        assertEquals(24, Underworld.GOLD_ORE_LOW_COUNT);
        assertEquals(8, Underworld.GOLD_ORE_FULL_COUNT);
        assertEquals(4, Underworld.GOLD_ORE_SIZE);
        assertEquals(72, Underworld.IRON_ORE_LOW_COUNT);
        assertEquals(24, Underworld.IRON_ORE_FULL_COUNT);
        assertEquals(6, Underworld.IRON_ORE_SIZE);
        assertEquals(12, Underworld.MITHRIL_ORE_LOW_COUNT);
        assertEquals(4, Underworld.MITHRIL_ORE_FULL_COUNT);
        assertEquals(3, Underworld.MITHRIL_ORE_SIZE);
        assertEquals(16, Underworld.ADAMANTIUM_ORE_LOW_COUNT);
        assertEquals(3, Underworld.ADAMANTIUM_ORE_SIZE);
        assertEquals(12, Underworld.REDSTONE_ORE_LOW_COUNT);
        assertEquals(4, Underworld.REDSTONE_ORE_FULL_COUNT);
        assertEquals(5, Underworld.REDSTONE_ORE_SIZE);
        assertEquals(6, Underworld.DIAMOND_ORE_LOW_COUNT);
        assertEquals(2, Underworld.DIAMOND_ORE_FULL_COUNT);
        assertEquals(3, Underworld.DIAMOND_ORE_SIZE);
        assertEquals(6, Underworld.LAPIS_ORE_LOW_COUNT);
        assertEquals(2, Underworld.LAPIS_ORE_FULL_COUNT);
